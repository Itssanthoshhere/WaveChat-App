...
const ProfileTab = () => {
  ...
  return (
    <ScrollView
      ...
      showsVerticalScrollIndicator={false} // Hide scroll indicators on both platforms
      // indicatorStyle="white" // Uncomment if you want white scroll indicators (works on iOS)
